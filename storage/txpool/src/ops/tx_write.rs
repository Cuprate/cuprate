...
use cuprate_database::{DatabaseRw, DbResult, StorableVec, WriteMode};
...
pub fn add_transaction(
    ...
    tables
        ...
        .put(&tx.tx_hash, StorableVec::wrap_ref(&tx.tx_blob), WriteMode::Normal)?;
    ...
    tables
        ...
        .put(&tx.tx_hash, &cached_verification_state, WriteMode::Normal)?;
    ...
    tables
        ...
        .put(&blob_hash, &tx.tx_hash, WriteMode::Normal)?;
