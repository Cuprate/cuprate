...
impl<D: ExtractDuration, S: AsyncWrite + AsyncRead> AsyncRead for WriteTimeout<D, S> {
    #[inline]
    fn poll_read(
        self: Pin<&mut Self>,
        cx: &mut Context<'_>,
...
impl<D: ExtractDuration, S: AsyncRead + AsyncWrite> AsyncWrite for ReadTimeout<D, S> {
    #[inline]
    fn poll_write(
        self: Pin<&mut Self>,
        cx: &mut Context<'_>,
    ...
    fn poll_write_vectored(
        ...
        self.project().reader.poll_write_vectored(cx, buf)
    }
