...
/// # Errors
///
/// This function may return an error if any inner service has an unrecoverable error.
pub async fn start_txpool_manager(
    ...
    task_executor.spawn_critical(manager.run(tx_rx, spent_kis_rx, shutdown_token));
