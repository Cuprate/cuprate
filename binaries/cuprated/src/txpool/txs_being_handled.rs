...
#[derive(Clone)]
pub(crate) struct TxsBeingHandled(Arc<DashSet<[u8; 32]>>);
...
impl TxsBeingHandled {
    ...
    pub(crate) fn local_tracker(&self) -> TxsBeingHandledLocally {
...
pub(crate) struct TxsBeingHandledLocally {
...
impl TxsBeingHandledLocally {
    ...
    pub(crate) fn try_add_tx(&mut self, tx_blob_hash: [u8; 32]) -> bool {
